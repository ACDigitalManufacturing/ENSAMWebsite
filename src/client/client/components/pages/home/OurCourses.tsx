  ...
  return (
    <div className={styles.ourCoursesWrapper} id={id.courses}>
      <div className={styles.headerContainer}>
        ...
        <a href={localRoutes.formation} className="customSeeMore">
          voir all <span>{right}</span>
        </a>
      </div>
        ...
        {CoursesList.map(({ icon, title, description, link }, idx) => (
          <li key={idx}>
            ...
            <div className={styles.info}>
              ...
              <a href={link} className="customSeeMore" target="_blank">
...
const CoursesList = [
  ...
  },
  {
    ...
    link: "/files/formations/ingenieur/GEM.pdf",
  },
  {
    icon: msei,
    ...
    link: "/files/formations/ingenieur/MSEI.pdf",
  },
  {
    icon: gm,
    ...
    link: "/files/formations/ingenieur/GM.pdf",
  },
  {
    icon: gi,
    ...
    link: "/files/formations/ingenieur/GI.pdf",
  },
  {
    icon: iagi,
    ...
    link: "/files/formations/ingenieur/IAGI.pdf",
  },
];
